...
scottTips:
  logistics: "Fly into Aspen (ASE) if cost isn't the primary concern — direct flights from Denver, Dallas, NYC, Chicago, and LA. Drive from Denver is 220 miles, 4 hours on I-70 and CO-82 — Glenwood Canyon is extraordinary but closes in weather."
...
Aspen is America's most glamorous mountain town — four ski mountains, a Victorian silver mining downtown, world-class cultural institutions, and Maroon Bells (the most photographed mountains in Colorado), budget $120-400+/day.

<div class="immersive-break-inline">
  <video autoplay muted loop playsinline preload="metadata">
    <source src="/videos/destinations/aspen-hero.mp4" type="video/mp4" />
  </video>
  <div class="ib-gradient" style="background: linear-gradient(135deg, #1e3a5f, #e5e7eb, #7c2d12);"></div>
  <div class="ib-content">
    <div class="ib-title">The Glamour Mountain</div>
    <p class="ib-text">Aspen's four ski mountains, Victorian silver mining downtown, and Maroon Bells backdrop create America's most iconic mountain town — and one of its most expensive.</p>
  </div>
</div>
