...
scottTips:
  logistics: "Denver to Estes Park: 75 miles, 1.5 hours on US-36 or US-34 through Big Thompson Canyon. RMNP timed entry reservations required May-October — book at recreation.gov before leaving Denver."
...
Estes Park is the charming gateway town to Rocky Mountain National Park — famous for elk walking down main street, the haunted Stanley Hotel, and stunning mountain valley scenery, budget $70-180/day, best June through October.

<div class="immersive-break-inline">
  <video autoplay muted loop playsinline preload="metadata">
    <source src="/videos/destinations/estes-park-hero.mp4" type="video/mp4" />
  </video>
  <div class="ib-gradient" style="background: linear-gradient(135deg, #1e3a5f, #065f46, #334155);"></div>
  <div class="ib-content">
    <div class="ib-title">Gateway Town</div>
    <p class="ib-text">Estes Park sits at the confluence of two mountain valleys with Rocky Mountain National Park beginning at the edge of town — elk routinely wander the streets and golf courses.</p>
  </div>
</div>
